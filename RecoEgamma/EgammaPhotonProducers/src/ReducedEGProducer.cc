...
void ReducedEGProducer::produce(edm::Event& theEvent, const edm::EventSetup& theEventSetup) {
  ...
  std::auto_ptr<reco::PhotonCollection> ootPhotons(new reco::PhotonCollection);
  std::auto_ptr<reco::PhotonCoreCollection> ootPhotonCores(new reco::PhotonCoreCollection);
  ...
  const edm::OrphanHandle<reco::PhotonCoreCollection> &outOOTPhotonCoreHandle = theEvent.put(ootPhotonCores,outOOTPhotonCores_);
  ...
  const edm::OrphanHandle<reco::PhotonCollection> &outOOTPhotonHandle = theEvent.put(ootPhotons,outOOTPhotons_);  
